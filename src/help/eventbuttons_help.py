...
def content() -> str:
    ...
    tbl_Commands.add_row(['&#160;','pidDerivativeFilter(<n>)',QApplication.translate('HelpDlg','sets derivative filter size;  0 <= n < 6 (n:int)')])
    tbl_Commands.add_row(['&#160;','pidDerivativeLimit(<n>)',QApplication.translate('HelpDlg','sets derivative limit (Dlimit); n >= 0')])
    tbl_Commands.add_row(['&#160;','pidILF(<n>)',QApplication.translate('HelpDlg','sets integral limit factor; 0<=n<=1 (n:float)')])
    tbl_Commands.add_row(['&#160;','pidIWP(<bool>)',QApplication.translate('HelpDlg','toggles integral windup prevention')])
    tbl_Commands.add_row(['&#160;','pidIRoC(<bool>)',QApplication.translate('HelpDlg','toggles integral reset on target')])
