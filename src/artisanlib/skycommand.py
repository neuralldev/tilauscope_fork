#
# ABOUT
# Skywalker V1 support for Artisan through Skycommand dongle
#
...
class SkyCommand(ClientBLE):

    # Skywalker V1 Skycommand ESP32 S3 custom service and characteristics
    ...
    def _parse(self, line:bytes) -> None:
        ...
        try:
            ...
            _log.debug('Skycommand parsed line: ambient=%d, et=%.1f, bt=%.1f', ambient, et, bt)
