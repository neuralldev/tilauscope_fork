#
# ABOUT
# RoastPATH HTML roast profile importer for artisan scope
#
...
def extractProfileRoastPathHTML(url:'QUrl',
    ...
    try:
        ...
        for elem in ['btData', 'etData', 'atData', 'eventData', 'rorData', 'noteData', 'fuelData', 'fanData', 'drumData']:
            ...
            if d:
                data[elem] = json.loads(d[0]) # type: ignore[literal-required, misc, unused-ignore] # generic strings accessors cannot be handled by mypy
