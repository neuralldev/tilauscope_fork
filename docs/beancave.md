...
outside service, and nothing on your network belongs there. A link that looks public but leads to
your own network, by a redirection or by the name it points to, is refused on the same grounds.
